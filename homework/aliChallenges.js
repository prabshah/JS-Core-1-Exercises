...
console.log('=============== Additional Challenges from Ali  ===================');
...
// This function only checks the match if the number provided is between 1 and 5
...
const guessNumber = (num) => {
    ...
    var randNum = Math.floor(Math.random() * 5 + 1);
     if (num === randNum) {
        ...
        console.log(`Try again! Please supply the number between 1 and 5. Number ${num} is not accepted.`);
    }
}
...
console.log('====================== Solution of question 9 ====================');

console.log(`Didn't understand the question!!`)





console.log('====================== Solution of question 10 ====================');

const reverseStr = (str) => {
    let strSplit = str.split(''),
        reversedArry = strSplit.reverse();
    return reversedArry.join('');
}

console.log(reverseStr('Hello'));
console.log(reverseStr('MURDER'));